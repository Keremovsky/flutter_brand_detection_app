...
import 'package:flutter_brand_detection_app/core/services/json_service.dart';
        ...
        actions: [
          CustomButton(
            onTap: () {
              ...
              jsonService.downloadJsonFile(context, history);
            },
            ...
            child: Padding(
              ...
              child: Image(
                image: isThemeLight
                    ? const AssetImage(AssetsConstants.jsonLogoBlack)
                    : const AssetImage(AssetsConstants.jsonLogoWhite),
              ),
            ),
          ),
          CustomButton(
            onTap: () {
              final history = ref.read(historyControllerProvider);
              excelService.downloadExcelFile(context, history);
            },
            backgroundColor: Colors.transparent,
            elevation: 0,
            borderRadius: BorderRadius.circular(100),
