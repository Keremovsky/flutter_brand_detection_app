...
class SavedHistoryScreen extends ConsumerStatefulWidget {
  const SavedHistoryScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _SavedHistoryScreenState();
}

class _SavedHistoryScreenState extends ConsumerState<SavedHistoryScreen> {
